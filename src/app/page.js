      ...
      <div className={styles.trustBar}>
        <div className={styles.trustItem}>
          ...
          <div className={styles.trustText}>
            <span className={styles.trustLabel}>Same Day</span>
            <span className={styles.trustSub}>Service Available</span>
          </div>
        </div>
        ...
        <div className={styles.trustItem}>
          ...
          <div className={styles.trustText}>
            <span className={styles.trustLabel}>Lifetime</span>
            <span className={styles.trustSub}>Warranty</span>
          </div>
        </div>
        ...
        <div className={styles.trustItem}>
          ...
          <div className={styles.trustText}>
            <span className={styles.trustLabel}>Free Shuttle</span>
            <span className={styles.trustSub}>Up to 5 miles*</span>
          </div>
        </div>
        ...
        <div className={styles.trustItem}>
          ...
          <div className={styles.trustText}>
            <span className={styles.trustLabel}>Ceramic</span>
        ...
        <div className={styles.trustItem}>
          ...
          <div className={styles.trustText}>
            <span className={styles.trustLabel}>Business</span>
